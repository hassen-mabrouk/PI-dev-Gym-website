<?PHP
include "C:/xampp/htdocs/projet web/backoffice/controller/categorieC.php";
...
<!-- Mirrored from View/html/gym/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Nov 2020 18:53:48 GMT -->
<head>
<meta charset="utf-8">
<title>Gym HTML-5 Template | Blog</title>
<!-- Stylesheets -->
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	...
                	<div class="blog-classic">
						...
						<div class="news-block-three">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h3><a href="blog-single.html">All about eggs and their benefits</a></h3>
									<div class="text">
										You hear a lot of bad things about eggs. "It's dangerous for your health", "it's full of cholesterol.</div>
						...
						<div class="news-block-four">
							<div class="inner-box" style="background-image:url(images/background/pattern-12.png)">
								<h3><a href="blog-single.html">What an Amazing Trainning Class! <br> Excellent Mentor, Great Caew</a></h3>
								<div class="designation">GYM Member <span>Matie Simms Junior</span></div>
							</div>
						</div>
						...
						<div class="news-block-three">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h3><a href="blog-single.html">What do I eat before my workout?</a></h3>
									<div class="text">A workout will require energy. Whether the session is a cardiovascular activity or a strengthening.</div>
									<a class="read-more" href="blog-single.html">Read More</a>
								</div>
							</div>
						</div>
						...
						<div class="news-block-three">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h3><a href="blog-single.html">The truth about sweet / sugar-free (light / zero) & energy drinks</a></h3>
									<div class="text">For several years now, we have read that sugar is bad for health, that it greatly contributes to the increase.</div>
									<a class="read-more" href="blog-single.html">Read More</a>
								</div>
							</div>
						</div>
						...
						<div class="news-block-three">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h3><a href="blog-single.html">weight loss program</a></h3>
									<div class="text">We are often looking for the miracle and easy solution to lose weight and find a silhouette that makes you dream.</div>
									<a class="read-more" href="blog-single.html">Read More</a>
								</div>
							</div>
						</div>
                	...
                	<aside class="sidebar sticky-top">
						...
						<div class="sidebar-widget categories-widget">
                            ...
                            foreach ($listC as $row) {
                                                    ...
                                                    /
								<ul class="blog-cat">
                                <li><a href="#"><?PHP echo $row['name'];   ?> <span>( <?PHP echo $row['creation'];   ?>  )</span></a></li>
                                </ul>
                                <?php
                                                }
                                                ?>
...
<!-- Mirrored from View/html/gym/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Nov 2020 18:54:00 GMT -->
</html>