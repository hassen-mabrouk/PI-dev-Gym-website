...
include "../controller/commentC.php";
	 ...
	 $commentaire=new commentC;
    if (isset($_GET['key'])) {
        $listC = $commentaire->rechercheCom($_GET['key']);
    } else {
        $listC = $commentaire->affichercomment();
    }


if (isset ($_POST['supprimer']))
{   
$req="delete from comment where id=".$_POST['id'];
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.html">Gestion Blog</a></li>
                                    <li><a href="gcb.php">Gestion Catergorie Blog</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion Blog</h4>
                                    </div>
                                </div>
                            </div>
