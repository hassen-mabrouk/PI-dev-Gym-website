                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="gb.php">Gestion Blog</a></li>
                                    <li><a href="gcb.html">Gestion Catergorie Blog</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Gestion Catergorie Blog</h4>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Catergorie</h4>
                                            <table class="table">
                                                <thead>
                                                <tr>
                                                    
                                                    <th>Name Catergorie</th>
