    ...
    <body class="fixed-left">
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                <td  rowspan='6' colspan='1'><h4>Categorie<h4></td>
                ...
                <tr >
                    ...
                    <td><select name="nom" >
                    <option value="Surfset fitness">Surfset fitness</option> 
                    <option value="Aerial yoga">Aerial yoga</option>
                    <option value="Batchata">Batchata</option>
                    <option value="Aqua bike">Aqua bike</option>
                         </select></td>
                </tr>
                ...
                <tr >
                    ...
                    <td>
                    <input type="date" id="date_creation" name="date_creation" min="2020-12-01" max="2020-12-07">
                ...
                <td>
                <button type="button" onclick="document.getElementById('id_categorie_planning').style.display='block'" value="Modifier" type="submit" class="btn btn-outline-success"> <i class="fas fa-check"></i></button>
                          
                          <div id="id_categorie_planning" class="modal">
                            <div class="alert alert-primary alert-dismissible fade show" role="alert">
                              <form method="POST" action="gcp copie.php">
                                <strong>Great !</strong> You just added 
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                                <div class="clearfix ">
                                  <input type="submit" onclick="document.getElementById('id_categorie_planning').style.display='none'" class="btn-secondary" value="Okay">
                                </div>
                              </form>
                            </div>
                          </div>
...
<script>
               ...
               <!-- <button   class="btn btn-outline-success" type="submit" ><i class="fas fa-check"></i></i> </button>        -->           
              <!-- <button type="button" onclick="document.getElementById('id_categorie_planning').style.display='block'" value="Modifier" type="submit" class="btn btn-outline-success"> <i class="fas fa-check"></i></button>
...
<div id="id_categorie_planning" class="modal">
  ...
  <form class="modal-content" method="POST" action="gcp copie.php">
    <div class="container ">
      ...
      <h1>You just added  informations</h1>
